...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'はい。サービス改善と統計分析を目的として、診断の回答内容、診断結果、フィードバックを匿名でデータベースに保存しています。ただし、IPアドレス、氏名、メールアドレス等の個人を特定できる情報は一切保存されません。会員登録や個人情報の入力は不要です。詳細はプライバシーポリシーをご確認ください。'
  },
  {
    question: 'アクセス解析（Cookie等）は使っていますか？',
    answer:
      'はい。本サービスでは、Google Analyticsを使用してアクセス解析を行っています。訪問者数、ページビュー、利用環境などの統計情報を匿名で収集し、サービス改善に役立てています。個人を特定する情報は収集されません。詳細はプライバシーポリシーをご確認ください。'
  },
  {
